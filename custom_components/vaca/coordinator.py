...
This exists here to support backward compatibility pre 2026.9.0, when the coordinator was moved.
Remove this by 2026.12 and force min version to be 2026.9.0 or later, which has the coordinator in homeassistant.components.wyoming.
"""
